...
URL Source: https://crates.io/crates/steamguard-cli

Markdown Content:
## [](https://crates.io/crates/steamguard-cli#steamguard-cli)steamguard-cli

[![Image 1: Lint, Build, Test](https://github.com/dyc3/steamguard-cli/actions/workflows/rust.yml/badge.svg)](https://github.com/dyc3/steamguard-cli/actions/workflows/rust.yml)[![Image 2: AUR Tester](https://github.com/dyc3/steamguard-cli/actions/workflows/aur-checker.yml/badge.svg)](https://github.com/dyc3/steamguard-cli/actions/workflows/aur-checker.yml)
...
## [](https://crates.io/crates/steamguard-cli#disclaimer)Disclaimer
...
## [](https://crates.io/crates/steamguard-cli#quickstart)Quickstart

If you have no idea what the rest of this document is talking about, go read the [quickstart](https://github.com/dyc3/steamguard-cli/blob/HEAD/docs/quickstart.md).

## [](https://crates.io/crates/steamguard-cli#features)Features
...
## [](https://crates.io/crates/steamguard-cli#install)Install
...
## [](https://crates.io/crates/steamguard-cli#building-from-source)Building From Source

```
cargo build --release
```

## [](https://crates.io/crates/steamguard-cli#usage)Usage
...
Your `maFiles` can be created with or imported from [Steam Desktop Authenticator](https://github.com/Jessecar96/SteamDesktopAuthenticator). You can create `maFiles` with steamguard-cli using the `setup` action (`steamguard setup`).
...
## [](https://crates.io/crates/steamguard-cli#one-liners)One Liners
...
## [](https://crates.io/crates/steamguard-cli#importing-2fa-secret-into-other-applications)Importing 2FA Secret Into Other Applications
...
## [](https://crates.io/crates/steamguard-cli#contributing)Contributing
...
## [](https://crates.io/crates/steamguard-cli#license)License
...
## [](https://crates.io/crates/steamguard-cli#used-by)Used By
