...
URL Source: https://www.kernel.org/doc/html/latest/admin-guide/mm/zswap.html

Markdown Content:
## Overview[¶](https://www.kernel.org/doc/html/latest/admin-guide/mm/zswap.html#overview "Permalink to this heading")
...
## Design[¶](https://www.kernel.org/doc/html/latest/admin-guide/mm/zswap.html#design "Permalink to this heading")
...
When the compressor parameter is changed at runtime, any existing compressed pages are not modified; they are left in their own pool. When a request is made for a page in an old pool, it is uncompressed using its original compressor. Once all pages are removed from an old pool, the pool and its compressor are freed.
